...
export default function CardContato({ onClose }) {
  ...
  return (
    <div className="w-full h-auto lg:h-full">
      <div className="glass-card rounded-[20px] p-4 lg:p-5 shadow-2xl relative overflow-hidden flex flex-col h-auto group transition-all duration-500 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]">
